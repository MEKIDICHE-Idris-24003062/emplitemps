<?php
namespace App;
use PDO; use PDOException; use Exception;
...
public static function pdo(): PDO { if(!self::$pdo) self::init(); return self::$pdo; }
...
// seed first user if env set
$seedEmail = getenv('SEED_EMAIL'); $seedPass = getenv('SEED_PASSWORD');
